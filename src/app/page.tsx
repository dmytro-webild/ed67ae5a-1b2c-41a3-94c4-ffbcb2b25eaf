...
import { Sprout, Zap, Smartphone, Star } from 'lucide-react';
      ...
      <div id="features" data-section="features">
        <FeatureCardSix
          ...
          features={[
            ...
            {
              id: 2,
              title: "Weather & Water Management",
              description: "Location-specific weather forecasts, rainfall predictions, and water conservation techniques to optimize irrigation and reduce water stress.",
              imageSrc: "http://img.b2bpic.net/free-vector/ecology-background-design_1212-319.jpg",
            },
            {
              id: 3,
              title: "Market Price Intelligence",
              description: "Live mandi rates, price trends, and best-selling timing recommendations to help farmers maximize profits on crop sales.",
          ...
          products={[
            {
              ...
              rating: 5,
              reviewCount: "Easy",
              imageSrc: "http://img.b2bpic.net/free-photo/smiley-man-indicating-phone-mock-up_23-2148233425.jpg",
            },
            {
              id: "step-2",
              brand: "Step 2",
            ...
            },
            {
              ...
              rating: 5,
              reviewCount: "Instant",
              imageSrc: "http://img.b2bpic.net/free-photo/woman-science-assistant-agricultural-officer-greenhouse-farm-research-melon_1150-10626.jpg",
            },
            {
              id: "step-4",
              brand: "Step 4",
          ...
          metrics={[
            {
              ...
              description: "Using Kisan AI across 15 states in India",
              imageSrc: "http://img.b2bpic.net/free-photo/portrait-indian-people-celebrating-baisakhi-festival_23-2151216938.jpg",
            },
            {
              id: "2",
              value: "₹2.5 Cr+",
              title: "Farmer Income Increased",
              description: "Average 25-40% yield and profit improvement",
              imageSrc: "http://img.b2bpic.net/free-photo/smiley-man-looking-away-field_23-2148233497.jpg",
            },
            {
              id: "3",
              value: "98%",
              title: "Satisfaction Rate",
              description: "Farmers rate our advice as highly reliable",
              imageSrc: "http://img.b2bpic.net/free-photo/young-farmer-taking-care-his-business_329181-15998.jpg",
            },
            {
              id: "4",
              value: "8",
      ...
      <div id="faq" data-section="faq">
        <FaqSplitMedia
          ...
          faqs={[
            {
              id: "1",
              title: "क्या Kisan AI सभी भारतीय भाषाओं में उपलब्ध है?",
              content: "हाँ, Kisan AI 8 भारतीय भाषाओं में काम करता है: हिंदी, पंजाबी, गुजराती, मराठी, तमिल, तेलुगु, कन्नड़, और बंगाली। आप अपनी पसंद की भाषा चुन सकते हैं और सभी सलाह अपनी भाषा में प्राप्त कर सकते हैं।",
            },
            {
              id: "2",
              title: "क्या यह छोटे जोतों वाले किसानों के लिए भी उपयोगी है?",
              content: "बिल्कुल! Kisan AI विशेष रूप से छोटे जोतों (1-5 एकड़) वाले किसानों के लिए डिजाइन किया गया है। हमारी सलाह कम लागत वाली तकनीकों और government schemes पर केंद्रित है जो छोटे किसानों को सर्वाधिक लाभ देते हैं।",
            },
            {
              id: "3",
              title: "Kisan AI के लिए कौन-कौन सी जानकारी देनी पड़ेगी?",
              content: "आपको अपना नाम, गांव, खेत का आकार, मिट्टी का प्रकार, और आप क्या फसल उगाते हैं—यह जानकारी देनी होगी। फिर Kisan AI आपकी location और farm profile के अनुसार personalized recommendations देगा। कोई भी sensitive personal data नहीं मांगा जाता।",
            },
            {
              id: "4",
              title: "क्या Kisan AI government schemes की जानकारी देता है?",
              content: "हाँ, Kisan AI में PM Kisan, crop insurance, fertilizer subsidies, irrigation schemes, और अन्य केंद्रीय और state-level schemes की अपडेटेड जानकारी है। हम आपको बताते हैं कि आप किन schemes के लिए eligible हैं और कैसे apply करें।",
            },
            {
              id: "5",
              title: "क्या Kisan AI livestock care के लिए भी काम करता है?",
              content: "हाँ, Kisan AI में पशुपालन के लिए भी comprehensive guidance है। हम animal health diagnostics, vaccination schedules, feed optimization, और veterinary emergency support देते हैं। यह cattle, goats, poultry, और dairy operations सभी के लिए काम करता है।",
            },
            {
              id: "6",
              title: "Market prices की जानकारी कितनी frequently update होती है?",
              content: "Market prices real-time में update होती हैं। आप अपने nearest mandi के latest prices देख सकते हैं और Kisan AI आपको सलाह देता है कि सही selling time क्या है। Price trends से आप भविष्य की planning कर सकते हैं।",
            },
            {
              id: "7",
              title: "क्या Kisan AI पूरी तरह free है?",
              content: "Kisan AI का basic advisory service बिल्कुल free है। हम farmers को कभी charged नहीं करते। Premium features जैसे advanced analytics या consulting भविष्य में आ सकते हैं, लेकिन core guidance सदा free रहेगी।",
            },
            {
              id: "8",
              title: "अगर मेरा सवाल FAQ में नहीं है तो?",
              content: "आप हमारे support team से direct contact कर सकते हैं। हम chat, email, और phone support सभी भारतीय भाषाओं में देते हैं। आपका सवाल कितना भी सरल हो, हम जवाब देंगे और मदद करेंगे।",
            },
          ]}
        />
      </div>
